      ...
      introJs()
        .addStep({
          intro:
            ...
            '<div>제작자</div>'+
            '<div><a href="https://twith.tv/morrc_kr" rel="noreferrer" class="text-blue-400">뭐_렉</a>, <a href="https://www.twitch.tv/pikokr" target="_blank" rel="noreferrer" class="text-blue-400">파링이</a>, <a href="https://www.twitch.tv/system_manager" target="_blank" rel="noreferrer" class="text-blue-400">초성_퀴즈</a></div>',
        })
        .addStep({
          intro:
